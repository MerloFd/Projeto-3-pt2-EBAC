...
public class ClienteDAO extends GenericDAO<Cliente, Long> implements IClienteDAO {
    ...
    public void atualiarDados(Cliente entity, Cliente entityCadastrado) {
        ...
        entityCadastrado.setPontos(entity.getPontos());
    }
    ...
    protected String getQueryInsercao() {
        ...
        sb.append("(ID, NOME, CPF, TEL, ENDERECO, NUMERO, CIDADE, ESTADO, PONTOS)");
    ...
    protected void setParametrosQueryInsercao(PreparedStatement stmInsert, Cliente entity) throws SQLException, SQLException {
        ...
        stmInsert.setLong(8,entity.getPontos());
    }
    ...
    protected void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, Cliente entity) throws SQLException {
        ...
        stmUpdate.setLong(7,entity.getPontos());
